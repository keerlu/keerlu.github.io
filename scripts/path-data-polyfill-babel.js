    ...
    try {
      for (var _iterator = pathData[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (type === "M") {
          ...
          absolutizedPathData.push({ type: "M", values: [_x, _y] });
          ...
          absolutizedPathData.push({ type: "L", values: [_x2, _y2] });
          ...
          absolutizedPathData.push({ type: "L", values: [_x3, _y3] });
          ...
          absolutizedPathData.push({ type: "C", values: [x1, y1, x2, y2, _x4, _y4] });
          ...
          absolutizedPathData.push({ type: "C", values: [_x5, _y5, _x6, _y6, _x7, _y7] });
          ...
          absolutizedPathData.push({ type: "Q", values: [_x8, _y8, _x9, _y9] });
          ...
          absolutizedPathData.push({
            type: "A",
            values: [rx, ry, xAxisRotation, largeArcFlag, sweepFlag, _x12, _y12]
          });
          ...
          var _seg$values10 = _slicedToArray(seg.values, 7),
              ...
              _x13 = _seg$values10[5],
              _y13 = _seg$values10[6];
          ...
          absolutizedPathData.push({
            type: "A",
            values: [_rx, _ry, _xAxisRotation, _largeArcFlag, _sweepFlag, _x13, _y13]
          });
          ...
          var _seg$values11 = _slicedToArray(seg.values, 1),
              _x14 = _seg$values11[0];

          absolutizedPathData.push({ type: "H", values: [_x14] });
          currentX = _x14;
        } else if (type === "h") {
          var _seg$values12 = _slicedToArray(seg.values, 1),
              _x15 = _seg$values12[0];

          _x15 += currentX;

          absolutizedPathData.push({ type: "H", values: [_x15] });
          currentX = _x15;
        } else if (type === "V") {
          var _seg$values13 = _slicedToArray(seg.values, 1),
              _y14 = _seg$values13[0];

          absolutizedPathData.push({ type: "V", values: [_y14] });
          currentY = _y14;
        } else if (type === "v") {
          var _seg$values14 = _slicedToArray(seg.values, 1),
              _y15 = _seg$values14[0];

          _y15 += currentY;

          absolutizedPathData.push({ type: "V", values: [_y15] });
          currentY = _y15;
        } else if (type === "S") {
          var _seg$values15 = _slicedToArray(seg.values, 4),
              _x16 = _seg$values15[0],
              _y16 = _seg$values15[1],
              _x17 = _seg$values15[2],
              _y17 = _seg$values15[3];

          absolutizedPathData.push({ type: "S", values: [_x16, _y16, _x17, _y17] });

          currentX = _x17;
          currentY = _y17;
        } else if (type === "s") {
          var _seg$values16 = _slicedToArray(seg.values, 4),
              _x18 = _seg$values16[0],
              _y18 = _seg$values16[1],
              _x19 = _seg$values16[2],
              _y19 = _seg$values16[3];
          ...
          var _seg$values17 = _slicedToArray(seg.values, 2),
              _x20 = _seg$values17[0],
              _y20 = _seg$values17[1];

          absolutizedPathData.push({ type: "T", values: [_x20, _y20] });

          currentX = _x20;
          currentY = _y20;
        } else if (type === "t") {
          var _seg$values18 = _slicedToArray(seg.values, 2),
              _x21 = _seg$values18[0],
              _y21 = _seg$values18[1];

          _x21 += currentX;
          _y21 += currentY;

          absolutizedPathData.push({ type: "T", values: [_x21, _y21] });
      ...
      for (var _iterator2 = pathData[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        if (seg.type === "M") {
          ...
          var _seg$values20 = _slicedToArray(seg.values, 6),
              ...
              x2 = _seg$values20[2],
              y2 = _seg$values20[3],
              _x22 = _seg$values20[4],
              _y22 = _seg$values20[5];

          reducedPathData.push({ type: "C", values: [x1, y1, x2, y2, _x22, _y22] });
          ...
          var _seg$values21 = _slicedToArray(seg.values, 2),
              _x23 = _seg$values21[0],
              _y23 = _seg$values21[1];

          reducedPathData.push({ type: "L", values: [_x23, _y23] });

          currentX = _x23;
          currentY = _y23;
        } else if (seg.type === "H") {
          var _seg$values22 = _slicedToArray(seg.values, 1),
              _x24 = _seg$values22[0];

          reducedPathData.push({ type: "L", values: [_x24, currentY] });

          currentX = _x24;
        } else if (seg.type === "V") {
          var _seg$values23 = _slicedToArray(seg.values, 1),
              _y24 = _seg$values23[0];

          reducedPathData.push({ type: "L", values: [currentX, _y24] });

          currentY = _y24;
        } else if (seg.type === "S") {
          var _seg$values24 = _slicedToArray(seg.values, 4),
              _x25 = _seg$values24[0],
              _y25 = _seg$values24[1],
              _x26 = _seg$values24[2],
              _y26 = _seg$values24[3];
          ...
          reducedPathData.push({ type: "C", values: [cx1, cy1, _x25, _y25, _x26, _y26] });
          ...
          var _seg$values25 = _slicedToArray(seg.values, 2),
              _x27 = _seg$values25[0],
              _y27 = _seg$values25[1];

          var _x28 = void 0,
              _y28 = void 0;

          if (lastType === "Q" || lastType === "T") {
            _x28 = currentX + (currentX - lastControlX);
            _y28 = currentY + (currentY - lastControlY);
          } else {
            _x28 = currentX;
            _y28 = currentY;
          }

          var _cx = currentX + 2 * (_x28 - currentX) / 3;
          var _cy = currentY + 2 * (_y28 - currentY) / 3;
          var cx2 = _x27 + 2 * (_x28 - _x27) / 3;
          var cy2 = _y27 + 2 * (_y28 - _y27) / 3;

          reducedPathData.push({ type: "C", values: [_cx, _cy, cx2, cy2, _x27, _y27] });
          ...
          var _seg$values26 = _slicedToArray(seg.values, 4),
              _x29 = _seg$values26[0],
              _y29 = _seg$values26[1],
              _x30 = _seg$values26[2],
              _y30 = _seg$values26[3];

          var _cx2 = currentX + 2 * (_x29 - currentX) / 3;
          var _cy2 = currentY + 2 * (_y29 - currentY) / 3;
          var _cx3 = _x30 + 2 * (_x29 - _x30) / 3;
          var _cy3 = _y30 + 2 * (_y29 - _y30) / 3;

          reducedPathData.push({ type: "C", values: [_cx2, _cy2, _cx3, _cy3, _x30, _y30] });
  ...
  SVGPathElement.prototype.getPathData = function (options) {
    if (options && options.normalize) {
      ...
      if (this[$cachedPathData]) {
        ...
        var _pathData = parsePathDataString(this.getAttribute("d") || "");
        this[$cachedPathData] = clonePathData(_pathData);
        return _pathData;
      }
    }
  };
